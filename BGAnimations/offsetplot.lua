...
o[#o+1] = Def.Quad{
	InitCommand=function(self)
		self:zoomto(plotWidth+plotMargin+12,plotHeight+plotMargin+12):diffuse(getMainColor('highlight')):diffusealpha(0.8)
	end
}

o[#o+1] = Def.Quad{
	InitCommand=function(self)
		self:zoomto(plotWidth+plotMargin+6,plotHeight+plotMargin+6):diffuse(color("0.05,0.05,0.05,0.5")):diffusealpha(0.9)
	end
}
