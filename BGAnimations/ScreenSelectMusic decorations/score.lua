...
t[#t+1] = LoadFont("_wendy small")..{
	InitCommand=function(self)
		self:xy(frameX+5,frameY+offsetY-9):zoom(0.5):halign(0):diffuse(getMainColor('positive'))
	end,
	BeginCommand=function(self)
...
t[#t+1] = LoadFont("_wendy small")..{
	Name="Score",
	InitCommand=function(self)
		self:xy(frameX+offsetX+55,frameY+offsetY+28):zoom(0.4):halign(0)
	end,
	SetCommand=function(self)
		if score and update then
...
t[#t+1] = LoadFont("_wendy small")..{
	Name="ClearType",
	InitCommand=function(self)
		self:xy(frameX+offsetX,frameY+offsetY+47):zoom(0.3):halign(0)
	end;
	SetCommand=function(self)
		if score and update then
...
t[#t+1] = LoadFont("_wendy small")..{
	Name="Combo",
	InitCommand=function(self)
		self:xy(frameX+offsetX,frameY+offsetY+70):zoom(0.2):halign(0)
	end;
	SetCommand=function(self)
		if score and update then
...
t[#t+1] = LoadFont("_wendy small")..{
	Name="MissCount",
	InitCommand=function(self)
		self:xy(frameX+offsetX,frameY+offsetY+85):zoom(0.2):halign(0)
	end;
	SetCommand=function(self)
		if score and update then
...
t[#t+1] = LoadFont("_wendy small")..{
	Name="Date",
	InitCommand=function(self)
		self:xy(frameX+offsetX,frameY+offsetY+101):zoom(0.2):halign(0)
	end;
	SetCommand=function(self)
		if score and update then
...
t[#t+1] = LoadFont("_wendy small")..{
	Name="Mods",
	InitCommand=function(self)
		self:xy(frameX+offsetX,frameY+offsetY+115):zoom(0.2):halign(0)
	end;
	SetCommand=function(self)
		if score and update then
...
t[#t+1] = LoadFont("_wendy small")..{
	Name="StepsAndMeter",
	InitCommand=function(self)
		self:xy(frameX+frameWidth-offsetX,frameY+offsetY+10):zoom(0.25):halign(1)
	end,
	SetCommand=function(self)
...
t[#t+1] = LoadFont("_wendy small")..{
	InitCommand=function(self)
		self:xy(frameX+frameWidth-offsetX,frameY+frameHeight-10):zoom(0.25):halign(1)
	end,
	SetCommand=function(self)
...
t[#t+1] = LoadFont("_wendy small")..{
	Name="ChordCohesion",
	InitCommand=function(self)
		self:xy(frameX+frameWidth/40,frameY+frameHeight-10):zoom(0.25):halign(0)
	end,
	SetCommand=function(self)
		if score and update then
...
local function makeJudge(index,judge)
	...
	local t = Def.ActorFrame{
		InitCommand=function(self)
			self:xy(frameX+offsetX,frameY+offsetY+142+((index-1)*18))
		end
	}
...
t[#t+1] = LoadFont("_wendy small")..{
	Name="Score",
	InitCommand=function(self)
		self:xy(frameX+offsetX,frameY+offsetY+296):zoom(0.2):halign(0)
	end,
	SetCommand=function(self)
		if score ~= nil and update then
