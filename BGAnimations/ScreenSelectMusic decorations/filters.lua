...
local f = Def.ActorFrame{
	...
	Def.Quad{
		InitCommand=function(self)
			self:zoomto(frameWidth,frameHeight):halign(0):valign(0):diffuse(color("#1E282FCC"))
		end
	},
	...
	LoadFont("_wendy small")..{
		InitCommand=function(self)
			self:xy(5,offsetY-9):zoom(0.5):halign(0):diffuse(getMainColor('positive')):settext("Filters (WIP)")
		end
	},
