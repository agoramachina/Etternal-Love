...
t[#t+1] = LoadFont("_wendy small") .. {
	InitCommand=function(self)
		self:xy(18,SCREEN_BOTTOM-235):visible(true):halign(0):zoom(0.4):maxwidth(capWideScale(get43size(360),360)/capWideScale(get43size(0.45),0.45))
	end,
	SetCommand=function(self)
...
t[#t+1] = Def.ActorFrame{
	...
	Def.Quad{
		InitCommand=function(self)
			self:xy(frameX,frameY-80):zoomto(110,98):halign(0):valign(0):diffuse(color("#1E282FCC")):diffusealpha(0.66)
		end
	},
	 --Lower Bar
	Def.Quad{
		InitCommand=function(self)
			self:xy(frameX,frameY+18):zoomto(frameWidth+4,50):halign(0):valign(0):diffuse(color("#1E282FCC")):diffusealpha(0.66)
		end
	},
	 --Side Bar (purple streak on the left)
	Def.Quad{
		InitCommand=function(self)
			self:xy(frameX,frameY-80):zoomto(8,148):halign(0):valign(0):diffuse(getMainColor('highlight')):diffusealpha(0.5)
		end
	},
	...
	LoadFont("_wendy small")..{
		InitCommand=function(self)
			self:xy(frameX+64,frameY+80):zoom(0.66):halign(0.5):maxwidth(125):valign(1)
		end,
		BeginCommand=function(self)
			self:queuecommand("Set")
		end,
	...
	LoadFont("Common Normal")..{
		InitCommand=function(self)
			self:xy(frameX+55,frameY+150):zoom(0.5):halign(0.5)
		end,
		BeginCommand=function(self)
			self:queuecommand("Set")
		end,
	...
	LoadFont("_wendy small")..{
		InitCommand=function(self)
			self:xy(frameX+185,frameY+59):zoom(0.2):halign(0)
		end,
		BeginCommand=function(self)
			self:queuecommand("Set")
		end,
	...
	LoadFont("_wendy small")..{
		InitCommand=function(self)
			self:xy(frameX+185,frameY+44):zoom(0.2):halign(0)
		end,
		BeginCommand=function(self)
			self:queuecommand("Set")
		end,
...
local function radarPairs(i)
	local o = Def.ActorFrame{
		LoadFont("_wendy small")..{
			InitCommand=function(self)
				self:xy(frameX+13,frameY-50+13*i):zoom(0.25):halign(0):maxwidth(146)
			end,
			SetCommand=function(self)
				if song then
		...
		LoadFont("_wendy small")..{
			InitCommand=function(self)
				self:xy(frameX+105,frameY-50+13*i):zoom(0.25):halign(1):maxwidth(60)
			end,
			SetCommand=function(self)
				if song then		
...
t[#t+1] = LoadFont("_wendy small") .. {
	InitCommand=function(self)
		self:xy((capWideScale(get43size(384),384))+62,SCREEN_BOTTOM-88):visible(true):halign(1):zoom(0.45,capWideScale(get43size(0.6),0.6)):maxwidth(capWideScale(get43size(360),360)/capWideScale(get43size(0.45),0.45))
	end,
	BeginCommand=function(self)
		self:queuecommand("Set")
	end,
...
t[#t+1] = Def.BPMDisplay {
	...
	Name="BPMDisplay",
	InitCommand=function(self)
		self:xy(capWideScale(get43size(384),384)+62,SCREEN_BOTTOM-110):halign(1):zoom(0.55)
	end,
	SetCommand=function(self)
		if song then 
			self:visible(1)
...
t[#t+1] = LoadFont("_wendy small") .. {
	...
	InitCommand=function(self)
		self:xy(capWideScale(get43size(384),384)+30,SCREEN_BOTTOM-110):halign(1):zoom(0.35)
	end,
	RefreshChartInfoMessageCommand=function(self)
		self:queuecommand("Set")
	end,
...
t[#t+1] = LoadFont("_wendy small") .. {
	InitCommand=function(self)
		self:xy(frameX+8,frameY-120):halign(0):zoom(0.4)
	end,
	BeginCommand=function(self)
		self:queuecommand("Set")
	end,
