...
function scoreBoard(pn,position)
	...
	t[#t+1] = Def.Quad{
		InitCommand=function(self)
			self:xy(frameX-5,frameY):zoomto(frameWidth+10,220):halign(0):valign(0):diffuse(color("#1E282FCC"))
		end
	};
	
	t[#t+1] = Def.Quad{
		InitCommand=function(self)
			self:xy(smoframeX,smoframeY):zoomto(zoomlength,zoomheight):halign(0):valign(0):diffuse(color("#1E282FCC"))
		end
	};
	...
	t[#t+1] = Def.Quad{
		InitCommand=function(self)
			self:xy(frameX-5,frameY+230):zoomto(frameWidth/2-10,60):halign(0):valign(0):diffuse(color("#1E282FCC"))
		end
	};
	for i=1,#fart do
	...
	t[#t+1] = Def.Quad{
		InitCommand=function(self)
			self:xy(frameWidth+25,frameY+230):zoomto(frameWidth/2+10,60):halign(1):valign(0):diffuse(color("#1E282FCC"))
		end
	};
